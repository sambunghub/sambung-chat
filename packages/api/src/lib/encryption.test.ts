...
import { encrypt, decrypt, generateEncryptionKey, extractLastChars, validateEncryptionConfig } from './encryption';
...
describe('Encryption Utilities', () => {
	...
	describe('validateEncryptionConfig', () => {
		...
		it('should throw when ENCRYPTION_KEY is not set', () => {
			...
			expect(() => validateEncryptionConfig()).toThrow('ENCRYPTION_KEY environment variable is not set');
		});
