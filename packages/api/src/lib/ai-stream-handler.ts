...
/**
 * Stream event types yielded during streaming completion
 *
 * Represents different events that can occur during streaming:
 * - text-delta: A chunk of text generated by the AI
 * - finish: Streaming completed with usage and finish reason
