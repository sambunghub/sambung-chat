...
├── index.ts              # i18n setup & configuration
├── locales/
...
| ---------------- | ------------------------------ | ---------------------- |
| Simplicity       | ✅ Simple API                  | ⚠️ More complex        |
| Flexibility      | ✅ App-based (no routing tied) | ❌ Route-based         |
| Svelte 5 Support | ✅ Full support                | ⚠️ May need adaptation |
| Bundle Size      | ✅ Lightweight                 | ⚠️ Larger              |
| TypeScript       | ✅ Type-safe                   | ✅ Type-safe           |
...
**File:** `apps/web/src/lib/i18n/locales/id.json`
...
**File:** `apps/web/src/lib/components/settings/LanguageSelector.svelte`
...
touch apps/web/src/lib/i18n/locales/zh.json
```
...
**File:** `apps/web/src/lib/i18n/types.ts`
...
declare module 'svelte-i18n' {
  interface Locales {
    en: typeof import('$lib/i18n/locales/en.json');
    id: typeof import('$lib/i18n/locales/id.json');
  }
}
```
