 ...
 * ```
 */
export function applyThemeById(themeId: string, customThemes?: Record<string, Theme>): boolean {
...
export function initializeTheme(
  ...
  const theme = themeId && availableThemes[themeId] ? availableThemes[themeId] : lightTheme;
