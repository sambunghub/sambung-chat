...
<div class="space-y-4">
  <!-- Server Error -->
  {#if error}
    <div class="bg-destructive/15 border-destructive text-destructive rounded-md border p-3 text-sm">
      {error}
    </div>
  {/if}
  ...
  <div class="space-y-2">
    ...
    <div class="relative">
      <Input
        ...
        required
        disabled={submitting}
        class="disabled:cursor-not-allowed disabled:opacity-50 pr-10"
      ...
      <button
        ...
        disabled={submitting}
        class="text-muted-foreground hover:text-foreground absolute right-3 top-1/2 -translate-y-1/2 disabled:cursor-not-allowed disabled:opacity-50"
