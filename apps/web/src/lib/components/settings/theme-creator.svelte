<script lang="ts">
  ...
  let { onThemeCreated, class: className, showPreview = true }: Props = $props();
...
<Card class={cn('overflow-hidden', className)}>
  ...
  <CardContent class="space-y-6">
    ...
    {#if showPreview}
      <div class="space-y-3">
        ...
        <div
          ...
          style="background-color: {getCssColor(colors.background)}; color: {getCssColor(
            colors.foreground
          )};"
        >
          <div class="space-y-4">
            <!-- Preview heading -->
            <h3 class="text-lg font-bold" style="color: {getCssColor(colors.primary)};">
              Sample Heading
            </h3>

            <!-- Preview paragraph -->
            <p class="text-sm leading-relaxed" style="color: {getCssColor(colors.foreground)};">
              This is how your theme will look when applied. The text color, background, and accents
              all reflect your chosen colors.
            </p>
            ...
            <div class="flex flex-wrap gap-2">
              <button
                ...
                style="background-color: {getCssColor(colors.primary)}; color: {getCssColor(
              ...
              <button
                ...
                style="border-color: {getCssColor(colors.border)}; color: {getCssColor(
                  colors.foreground
                )}; background-color: {getCssColor(colors.secondary)};"
                type="button"
              >
                Secondary Button
              </button>
              ...
              <button
                class="inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm font-medium transition-colors"
                style="background-color: {getCssColor(colors.destructive)}; color: {getCssColor(
            ...
            <div class="space-y-1">
              <input
                ...
                style="border-color: {getCssColor(colors.input)}; background-color: {getCssColor(
                  colors.background
                )}; color: {getCssColor(colors.foreground)};"
                readonly
              />
            </div>
            ...
            <div
              ...
              style="border-color: {getCssColor(colors.border)}; background-color: {getCssColor(
                colors.muted
              )};"
            >
    ...
    <div
      ...
      style="border-color: {getCssColor(colors.border)};"
    >
      <Button
