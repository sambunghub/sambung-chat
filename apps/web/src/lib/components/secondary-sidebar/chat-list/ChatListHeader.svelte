  ...
  <div class="flex gap-2">
    <DropdownMenu.DropdownMenu>
      ...
      <DropdownMenu.DropdownMenuContent>
        <DropdownMenu.DropdownMenuItem onclick={() => onExportAll('json')} disabled={exporting}>
          <FileJsonIcon class="mr-2 size-4" />
          <span>Export All as JSON</span>
        </DropdownMenu.DropdownMenuItem>
        <DropdownMenu.DropdownMenuItem onclick={() => onExportAll('md')} disabled={exporting}>
          <CodeIcon class="mr-2 size-4" />
          <span>Export All as Markdown</span>
        </DropdownMenu.DropdownMenuItem>
        <DropdownMenu.DropdownMenuItem onclick={() => onExportAll('zip')} disabled={exporting}>
