  ...
  <div class="space-y-8">
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>Main brand color for buttons, links, and active states</CardDescription>
      </CardHeader>
      <CardContent>
        <ColorPicker
          value={primaryColor}
          ...
          <div class="flex gap-2">
            {#each Object.entries(presetColors) as [name, color]}
              <button
                ...
                type="button"
              >
                <div class="size-4 rounded" style="background-color: hsl({color});"></div>
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>See how the selected colors look in actual UI components</CardDescription>
      </CardHeader>
      <CardContent>
        <div
        ...
        >
          <div class="space-y-4">
            <!-- Headings -->
            <div>
              <h2 class="text-2xl font-bold" style="color: hsl({foregroundColor});">
            ...
            <div class="flex flex-wrap gap-3">
              <button
                class="rounded-md px-4 py-2 font-medium text-white transition-colors"
                style="background-color: hsl({primaryColor});"
              >
                Primary Button
              </button>
              <button
                class="rounded-md border-2 px-4 py-2 font-medium transition-colors"
            ...
            <div class="grid gap-4 md:grid-cols-2">
              ...
              >
                <h3 class="mb-2 text-lg font-semibold" style="color: hsl({foregroundColor});">
                  Accent Card
                </h3>
    ...
    <Card>
      ...
      <CardContent>
        <div class="border-border bg-muted/30 rounded-lg border p-4">
          <pre class="font-mono text-sm">{JSON.stringify(
              {
