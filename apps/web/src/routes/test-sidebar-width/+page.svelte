...
<div class="container mx-auto max-w-3xl p-6">
	<div class="mb-8">
		...
		<p class="text-muted-foreground mt-2">
			This page tests the sidebar width slider component
		</p>
	</div>
	...
	<div class="space-y-8">
		...
		<div class="border-border rounded-lg border p-6">
			<h2 class="text-foreground mb-4 text-xl font-semibold">
				Sidebar Width Demonstration
			</h2>
			<p class="text-muted-foreground mb-4 text-sm">
				The sidebar width setting controls the secondary sidebar width across the
				application. Current width: <span class="text-primary font-semibold">{currentSettings.sidebarWidth}px</span>
				({(parseInt(currentSettings.sidebarWidth) / 16).toFixed(1)}rem)
			</p>
			<div class="flex gap-4">
				<div
					class="bg-muted flex items-center justify-center rounded-lg border-2 border-dashed border-border transition-all duration-300"
				...
				<div class="bg-muted/50 flex-1 rounded-lg border-2 border-dashed border-border p-4">
