      ...
      <Card>
        ...
        <CardContent class="space-y-3 text-sm">
          <ol class="list-decimal space-y-2 pl-4">
            <li>
              <span class="font-semibold">Enter a name</span> for your theme (required, 3-100
              characters)
            </li>
            <li>
            ...
            <li>
              <span class="font-semibold">Customize colors</span> using the color pickers for each
              theme aspect
            </li>
            <li>
    ...
    <CardContent class="space-y-6">
      ...
      <div class="space-y-3">
        ...
        <div class="grid gap-3 md:grid-cols-3">
          ...
          <div
            class="border-primary/50 bg-primary/10 text-primary rounded-md border p-4"
          >
